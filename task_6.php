                           ...
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                               ...
                               <?php if ($value["ban"] == "yes"): ?>
                                   ...
                                   <?php endif; ?>
                                       ...
                                       <img src="<?= $value["img"] ?>" alt="<?= $value["img_alt"] ?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                       <div class="ml-2 mr-3">
                                           <h5 class="m-0">
                                               <?= $value["name"] ?>
                                           ...
                                           <a href="https://twitter.com/<?= $value["twitter"] ?>" class="text-info fs-sm" target="_blank"><?= $value["twitter"] ?></a> -
                                           <a href="https://wrapbootstrap.com/user/<?= $value["wrapbootstrap"] ?>" class="text-info fs-sm" target="_blank" title="Contact Sunny"><i class="fal fa-envelope"></i></a>
                                       </div>
                                   </div>
                               <?php endforeach; ?>
                        </div>
